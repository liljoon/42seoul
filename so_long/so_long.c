...
{
	app->map.grass_ptr = mlx_xpm_file_to_image(app->mlx_ptr, \
		"./img/Grass.xpm", &(app->map.size), &(app->map.size));
	app->player.image_ptr = mlx_xpm_file_to_image(app->mlx_ptr, \
		"./img/player.xpm", &(app->player.size), &(app->player.size));
	app->map.wall_ptr = mlx_xpm_file_to_image(app->mlx_ptr, \
		"./img/wall.xpm", &(app->map.size), &(app->map.size));
	app->map.coll_ptr = mlx_xpm_file_to_image(app->mlx_ptr, \
		"./img/ChickenLeg.xpm", &(app->map.size), &(app->map.size));
	app->map.exit_ptr = mlx_xpm_file_to_image(app->mlx_ptr, \
		"./img/exit.xpm", &(app->map.size), &(app->map.size));
}
...
void	init_so_long(t_so_long *app, char *map_path)
{
	...
	app->win_ptr = mlx_new_window(app->mlx_ptr, \
		app->width * app->map.size, app->height * app->map.size, "so_long");
